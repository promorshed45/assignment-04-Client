...
const FeaturedProducts = () => {
  ...
  return (
    <div className="container mx-auto grid w-full max-w-7xl items-center space-y-4 px-4 py-5 md:py-10 sm:px-6 lg:px-8 md:grid-cols-2 md:gap-6 md:space-y-0 lg:grid-cols-4">
